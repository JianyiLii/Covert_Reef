...
::: {.callout-important title="1.4 Findings"}
-   All activity is between 7 AM and 2 PM, with a sharp rise from 8 AM, peaking 9–12 PM, then tapering off.

-   The single biggest spike is Oct 5 at 10 AM (\>20 messages).

-   Every day follows the same mid-morning “bell curve” with virtually zero messages outside those hours.
:::
...
::: {.callout-note title="1.5 Findings"}
